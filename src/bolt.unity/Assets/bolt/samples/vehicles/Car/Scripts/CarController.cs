...
public class CarController : BoltEntityBehaviour<CarSerializer, ICarState> {
  ...
  public int GearNum { get { return boltState.gear; } private set { boltState.gear = value; } }                                      // the current gear we're in.
  public float CurrentSpeed { get { return boltState.speed; } private set { boltState.speed = value; } }                                                                    // the current speed of the car
  public float CurrentSteerAngle { get { return boltState.steerAngle; } private set { boltState.steerAngle = value; } }                                                                 // The current steering angle for steerable wheels.
  public float AccelInput { get; private set; }                                   // the current acceleration input
  public float BrakeInput { get { return boltState.breakInput; } private set { boltState.breakInput = value; } }                                                                                                   // the current brake input
  public float GearFactor { get { return boltState.gearFactor; } private set { boltState.gearFactor = value; } }                                    // value between 0-1 indicating where the current revs fall within the current range of revs for this gear
  public float AvgPowerWheelRpmFactor { get { return boltState.rpmFactor; } private set { boltState.rpmFactor = value; } }                         // the average RPM of all wheels marked as 'powered'
  public float AvgSkid { get { return boltState.avgSkid; } private set { boltState.avgSkid = value; } }                                      // the average skid factor from all wheels
  public float RevsFactor { get { return boltState.revsFactor; } private set { boltState.revsFactor = value; } }                                    // value between 0-1 indicating where the current revs fall between 0 and max revs
  public float SpeedFactor { get { return boltState.speedFactor; } private set { boltState.speedFactor = value; } }                                  // value between 0-1 of the car's current speed relative to max speed
